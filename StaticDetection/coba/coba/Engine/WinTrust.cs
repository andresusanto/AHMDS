...
namespace coba.Engine
{
    ...
    public static class WinTrust
    {
        ...
        public static X509Certificate GetVerifiedCert(string filename){ // fungsi untuk mengambil hanya sertifikat yang terverifikasi

            if (VerifyEmbeddedSignature(filename))
            {
                return X509Certificate.CreateFromSignedFile(filename);
            }
